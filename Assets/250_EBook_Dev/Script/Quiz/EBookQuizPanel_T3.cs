...
{
    public class EBookQuizPanel_T3 : EBookQuizPanel
    {
        // Fields
        private EBookQuizData_Type3 quizData = null;

        // Overrides
        protected override int onGetQuizType() => 3;
        ...
        {
            quizData = data as EBookQuizData_Type3;
