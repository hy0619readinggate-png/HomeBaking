...
{
    public class EBookQuizPanel_T2 : EBookQuizPanel
    {
        // Fields
        private EBookQuizData_Type2 quizData = null;
        ...
        // Overrides
        protected override int onGetQuizType() => 2;
        ...
        {
            quizData = data as EBookQuizData_Type2;
            ...
            shuffled[0].Setup(quizData.TextCorrect, true);
            shuffled[1].Setup(quizData.TextWrong, false);
        }
