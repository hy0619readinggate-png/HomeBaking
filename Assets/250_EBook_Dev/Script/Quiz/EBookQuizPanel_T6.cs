...
{
    public class EBookQuizPanel_T6 : EBookQuizPanel
    {
        // Fields
        private EBookQuizData_Type6 quizData = null;

        // Overrides
        protected override int onGetQuizType() => 6;
        ...
        {
            quizData = data as EBookQuizData_Type6;
        ...
        protected override IEnumerator onReview()
        {
            ...
            causeTXT.text = quizData.TextCause;
            effectTXT.text = quizData.TextEffect;
        ...
        [SerializeField] private TextMeshProUGUI causeTXT = null;
        [SerializeField] private TextMeshProUGUI effectTXT = null;
