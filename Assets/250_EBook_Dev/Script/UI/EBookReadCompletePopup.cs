...
{
    public enum EBookPopupResult { NA, Back, Retry, Record, MyEBook, Quiz, Read };
    public class EBookReadCompletePopup : PopupBase<EBookPopupResult>
    {
        // Methods
        public async UniTask<EBookPopupResult> ShowPopup(Sprite thumbnail, int coinCount, bool read, bool recorded, bool quizDone)
        {
