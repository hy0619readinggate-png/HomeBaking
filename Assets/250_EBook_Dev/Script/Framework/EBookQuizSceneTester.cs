...
namespace DoDoEng.EBook.Framework
{
    ...
    public class EBookQuizSceneTester : MonoBehaviour
    {
        // Fields : caching
        private EBookQuizRunner runner_;
        private EBookQuizRunner runner => runner_ ??= GetComponent<EBookQuizRunner>();
        ...
        private void Awake()
        {
            if (RunnerParam.SelectedIDX == null)
            {
                ...
                var ebIDX = new EBookQuizIndex(mainCategory, subCategory, ebookNum);
