...
{
	public class MyInfoPopupPageToday : TabPage
    {
        // Definitions
        ...
        //{
        //    //subPages.ForEach(page => page.StopLoading());
        //}
        ...
        private void loadDay(DateTime dt)
        {
            ...
            //OnChangeDay?.Invoke(currentDT.ToString("yyyyMMdd"));
        ...
        //[SerializeField] private MyInfoPopupSubBase[] subPages = null;
