...
{
	public class MyInfoPopupPageTodayEBooks : MyInfoPopupSubBase
    {
        // Definitions
        // Properties

        // Methods
        public MyInfoPopupPageTodayEBooks()
        {
            category = "ebooks";
        }
        ...
        protected override async UniTask onLoad(CancellationToken cancellationToken, string date)
        {
            ...
            var result = await API.One.Call(UserData.One.Child.AccessToken, $"/api/v1/child/my-info/today/ebooks?searchDate={date}");
