...
{
    public class GameReviewCompletePopup : PopupBase<GamePopupResult>
    {
        // Methods
        public async UniTask<GamePopupResult> ShowPopup(int coinCount)
        {
        ...
        IEnumerator coPlayAnimation()
        {
            using (LOG.Coroutine($"coPlayAnimation()", this))
            {
                ...
                CloseWithResult(GamePopupResult.Back);
            }
        }
    }
}