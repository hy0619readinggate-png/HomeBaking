...
namespace DoDoEng.Game.C3_G03
{
        ...
        IDragHandler
    {
        ...
        public void Setup(string chunk, SentenceData sd) 
        {
            ...
            if (sd != null)
            {
                var typeIdx = sd.BlockType * 3 + Random.Range(0, 3); //타입별로 3개씩, 총 9개
                blockTypeIdx = sd.BlockType;
        ...
        public void Appear(int row, Transform appearTR)
        {
        ...
        private BlockRandomFallSFX sfx_ = null;
        private BlockRandomFallSFX sfx => sfx_ ??= GetComponentInChildren<BlockRandomFallSFX>();
        ...
        {
            anim.SetTrigger(hashKeyDrop);
            AudioMGR.One.PlayEffect(dropSFX[blockTypeIdx]);
