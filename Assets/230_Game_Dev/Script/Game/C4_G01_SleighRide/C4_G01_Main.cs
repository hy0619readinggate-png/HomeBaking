...
using ProblemMGR = DoDoEng.Game.C4_G01.C4_G01_ProblemMGR;

namespace DoDoEng.Game.C4_G01
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C4_G01_Main : GameMain<C4_G01_Main, GameData>
    {
        // Definitions
        enum State
        {
        ...
        // Overrides
        protected override GameID onGameID() => GameID.C4_G01_SleighSlide;
