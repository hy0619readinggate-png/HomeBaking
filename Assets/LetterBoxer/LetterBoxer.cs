...
public class LetterBoxer : MonoBehaviour
{
    ...
    private Camera cam;
    private static Camera letterBoxerCamera;
    ...
    {
        // 모든 LetterBoxer마다 letterBoxerCamera를 생성하는 것을 방지하기 위해, 싱글톤으로 생성하도록 수정함 by epic
        ...
        if (letterBoxerCamera == null)
        {
            ...
            DontDestroyOnLoad(letterBoxerCamera.gameObject);
        }
    }
