...
public class BuildScript : IPostprocessBuildWithReport
{
    // Definitions
    ...
    static void BuildWebGL()
    {
        ...
        // ���� ����
        var fileName = getPlayerBuildPath(BuildTarget.WebGL);
    ...
    private static string getPlayerBuildPath(BuildTarget buildTarget)
    {
        ...
        return buildTarget switch
        {
            ...
            BuildTarget.WebGL => $"{folder}/{APPNAME}-({Application.version})",
            _ => string.Empty
        };
    }
