...
using ProblemMGR = DoDoEng.Activity.C1_A12.C1_A12_ProblemMGR;

namespace DoDoEng.Activity.C1_A12
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C1_A12_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C1_A12_Sheep;
        private enum State
        {
            Intro,
            Enter, Problem,
