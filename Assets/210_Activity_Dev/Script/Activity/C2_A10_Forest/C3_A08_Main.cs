...
using ProblemMGR = DoDoEng.Activity.C2_A10.C3_A08_ProblemMGR;

// Variation : C2_A10_Forest, C3_A08_ToTheDesert
namespace DoDoEng.Activity.C2_A10
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C3_A08_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C3_A08_ToTheDesert;
        private enum State
        {
            Intro,
        ...
        protected override void onDebugNext()
        {
            switch (fsm.CurrentState)
            {
                ...
                case State.Wrong: fsm.PerformTransition(State.ProblemIn); break;
