...
using ProblemMGR = DoDoEng.Activity.C3_A09.C3_A09_ProblemMGR;

namespace DoDoEng.Activity.C3_A09
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C3_A09_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C3_A09_EclairShop;
        private enum State
        {
            Intro,
        ...
        {
            yield return breadMGR.StartHide(false);
