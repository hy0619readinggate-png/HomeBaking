...
using ProblemMGR = DoDoEng.Activity.C3_A06.C3_A06_ProblemMGR;

// Variation : C3_A06_Puzzle, C4_A02_NeonArcade
namespace DoDoEng.Activity.C3_A06
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C3_A06_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C3_A06_Puzzle;
        private enum State
        {
            Permission,
            Intro,
        ...
        private void enableButtons(bool enable)
        {
            ...
            nextBTN.Activate(recordMGR.IsRecorded || recordTryCount >= tryCountForForceNext);
        ...
        protected override void onDebugNext()
        {
            switch (fsm.CurrentState)
            {
                ...
                case State.Feedback:
                    ...
                    break;
                case State.ToPuzzle: fsm.PerformTransition(State.ShowPuzzle); break;
