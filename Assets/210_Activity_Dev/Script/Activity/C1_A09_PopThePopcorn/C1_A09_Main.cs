...
using ProblemMGR = DoDoEng.Activity.C1_A09.C1_A09_ProblemMGR;

namespace DoDoEng.Activity.C1_A09
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C1_A09_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C1_A09_PopThePopcorn;
        private enum State
        {
            S1Intro,
        ...
        private void introSIG_OnSignal(string signal)
        {
            ...
            if (signal == "Activity-ExtraAnimation")
                AudioMGR.One.PlayEffect(introLaughCLIP);
        }
        ...
        [Header("★ Sound")]
        [SerializeField] private AudioClip introLaughCLIP = null;
