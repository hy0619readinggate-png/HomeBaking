...
using ProblemMGR = DoDoEng.Activity.C3_A05.C3_A05_ProblemMGR;

// Variation : C3_A05_GrilledSkewers, C4_A03_IceFishing
namespace DoDoEng.Activity.C3_A05
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C3_A05_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C3_A05_GrilledSkewers;
        private enum State
        {
            Intro,
        ...
        private TimelineSignal wrong1UpSIG_ = null;
        private TimelineSignal wrong1UpSIG => wrong1UpSIG_ ??= wrongUpTL[0].GetComponent<TimelineSignal>();
        private TimelineSignal wrong2UpSIG_ = null;
        private TimelineSignal wrong2UpSIG => wrong2UpSIG_ ??= wrongUpTL[1].GetComponent<TimelineSignal>();
        private TimelineSignal wrong1DownSIG_ = null;
        private TimelineSignal wrong1DownSIG => wrong1DownSIG_ ??= wrongDownTL[0].GetComponent<TimelineSignal>();
        private TimelineSignal wrong2DownSIG_ = null;
        private TimelineSignal wrong2DownSIG => wrong2DownSIG_ ??= wrongDownTL[1].GetComponent<TimelineSignal>();
        ...
        private PlayableDirector wrongTL = null;
        ...
        IEnumerator E_Wrong()
        {
            ...
            if(submitedExam.ID ==  1)
                wrongTL = UtilArray.ExtractOne(wrongUpTL);
            else wrongTL = UtilArray.ExtractOne(wrongDownTL);
        ...
        [SerializeField] private PlayableDirector[] wrongUpTL = null;
        [SerializeField] private PlayableDirector[] wrongDownTL = null;
        ...
        protected override void OnEnable()
        {
            ...
            wrong1UpSIG.OnSignal += wrongSIG_OnSignal;
            wrong2UpSIG.OnSignal += wrongSIG_OnSignal;
            wrong1DownSIG.OnSignal += wrongSIG_OnSignal;
            wrong2DownSIG.OnSignal += wrongSIG_OnSignal;
        }
