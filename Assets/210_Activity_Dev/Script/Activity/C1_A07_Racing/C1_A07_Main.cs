...
using ProblemMGR = DoDoEng.Activity.C1_A07.C1_A07_ProblemMGR;


// Variation : C1_A07_Racing, C3_A02_CosmosRacing
namespace DoDoEng.Activity.C1_A07
{
    public class C1_A07_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C1_A07_Racing;
        private enum State
        {
            Intro, Start,
            Obstacle,
