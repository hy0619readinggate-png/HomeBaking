...
using ProblemMGR = DoDoEng.Activity.C2_A06.C4_A09_ProblemMGR;

namespace DoDoEng.Activity.C2_A06
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C4_A09_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C4_A09_DesertYoga;
