...
using ProblemMGR = DoDoEng.Activity.C2_A04.C2_A04_ProblemMGR;

namespace DoDoEng.Activity.C2_A04
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C2_A04_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C2_A04_BaroDownDown;
        private enum State
        {
            Intro,
        ...
        IEnumerator E_Wrong()
        {
            ...
            yield return playTimeline(wrongTL, 0);
            yield return null;
