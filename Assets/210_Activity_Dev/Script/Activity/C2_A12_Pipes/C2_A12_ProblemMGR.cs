...
{
    public class C2_A12_ProblemMGR : ActivityProblemMGR<ActivityData, ProblemData>
    {
        // Definitions
    ...
    public class ProblemData
    {
        ...
        public override string ToString()
        {
            return $"<color=red>ProblemData" +
                $"[{string.Join(",", Subjects.Select(ex => ex.Word))} | {string.Join(",", Examples.Select(ex => ex.Word))}]" +
                $"</color>";
        }
    }
    public class SubjectData
    {
        ...
        public override string ToString()
        {
            return $"<color=green>ProblemData" +
                $"[{Index} | {Word} ]" +
                $"</color>";
        }
    }
