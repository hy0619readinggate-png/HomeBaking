...
using ProblemMGR = DoDoEng.Activity.C2_A12.C4_A01_ProblemMGR;

namespace DoDoEng.Activity.C2_A12
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C4_A01_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C4_A01_FillupFuel;
        private enum State
        {
            Intro,
            Problem, Solve,
