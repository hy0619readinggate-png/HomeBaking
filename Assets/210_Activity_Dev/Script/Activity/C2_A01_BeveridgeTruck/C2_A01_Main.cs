...
using ProblemMGR = DoDoEng.Activity.C2_A01.C2_A01_ProblemMGR;

// Variation : C2_A01_BeveridgeTruck, C3_A01_HalloweenTruck
namespace DoDoEng.Activity.C2_A01
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C2_A01_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C2_A01_BeveridgeTruck;
        private enum State
        {
            Permission,
