...
using ActivityData = DoDoEng.Common.ActivityData_C1_A10;
using ProblemMGR = DoDoEng.Activity.C1_A10.C1_A10_ProblemMGR;

// Variation : C1_A10_FindTheMaze, C3_A03_BlockLand
namespace DoDoEng.Activity.C1_A10
{
    [RequireComponent(typeof(ProblemMGR))]
    public class C1_A10_Main : ActivityMain<ActivityData>
    {
        // Definitions
        private const ActivityID TheActivityID = ActivityID.C1_A10_FindTheMaze;
