...
namespace Coffee.UIExtensions
{
	...
	{
		private class AnimatedPropertiesEditor
		{
		...
		private static readonly Dictionary<string, MethodInfo> s_InternalMethods = new Dictionary<string, MethodInfo>();
		private static readonly Color s_GizmoColor = new Color(1f, 0.7f, 0.7f, 0.9f);
		...
		private SerializedProperty _spTrailParticle;
		private SerializedProperty _spScale;
		private SerializedProperty _spIgnoreParent;
		...
		private SphereBoundsHandle _sphereBoundsHandle = new SphereBoundsHandle();
		private Mesh _spriteMesh;

		private static T Call<T>(Type type, string method, params object[] args)
		{
			MethodInfo mi;
