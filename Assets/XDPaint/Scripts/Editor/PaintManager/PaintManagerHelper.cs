...
namespace XDPaint.Editor
{
    public static class PaintManagerHelper
    {
        ...
        public const string PaintingSpaceTooltip = "Painting space";
        public const string ProjectionMethodTooltip = "Projection method of brush texture to the mesh";
        public const string ProjectionDirectionTooltip = "Projection direction of brush texture to the mesh";
        public const string ProjectionAngleAttenuationModeTooltip = "Angle Attenuation Mode";
