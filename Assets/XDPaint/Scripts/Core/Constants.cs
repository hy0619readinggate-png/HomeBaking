...
namespace XDPaint.Core
{
    public static class Constants
    {
        ...
        public static class PaintWorldShader
        {
            public const string MainTexture = "_MainTex";
            public const string IslandMapTexture = "_IslandMap";
            public const string BrushTexture = "_BrushTex";
            public const int PositionsCount = 32;
            public const string PositionsArray = "_PaintPositions";
            public const string NormalsArray = "_Normals";
            public const string RotationsArray = "_RotationAngles";
            public const string PositionsArrayCount = "_PaintPositionsCount";
            public const string PointerPosition = "_PointerPosition";
            public const string BrushSizes = "_BrushSizes";
            public const string UsePlanarProjection = "_UsePlanarProjection";
            public const string UseNormalDirection = "_UseNormalDirection";
            public const string NormalCutout = "_NormalCutout";
            public const string MaxAngle = "_MaxAngle";
            public const string AngleAttenuationMode = "_AngleAttenuationMode";
            public const string BrushDepth = "_BrushDepth";
            public const string DepthFadeRange = "_DepthFadeRange";
            public const string EdgeSoftness = "_EdgeSoftness";
        }
        ...
        public static class AlphaMaskShader
        {
            public static readonly int MaskTexture = Shader.PropertyToID("_MaskTex");
            public const string SrcColorBlend = "_SrcColorBlend";
            public const string DstColorBlend = "_DstColorBlend";
