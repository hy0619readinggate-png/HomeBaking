...
namespace XDPaint.Controllers
{
    public partial class InputController : Singleton<InputController>
    {
        ...
        private bool interactable = true;       // Added by swon 2024.11.27
        private bool isDown = false;            // Added by swon 2024.11.27
        ...
        void Update()
        {
            ...
            else if ((inputMethods & InputMethods.Pen) == InputMethods.Pen)
            {
                ...
                // Added by swon 2025.02.18
                // 디바이스에서 터치모드 사용하지 않도록 수정
                //Touch / Mouse
