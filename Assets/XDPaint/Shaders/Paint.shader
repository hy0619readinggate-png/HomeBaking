    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vertex(appdata v)
            {
                ...
                o.uv = v.uv;
                #ifdef TILE_ON
                float2 scale = float2(_PatternTex_TexelSize.z / _MainTex_TexelSize.z, _PatternTex_TexelSize.w / _MainTex_TexelSize.w) * _PatternScale.xy;
                o.uvRotated.xy = RotateCentered(v.uv, scale, _PatternOffset, _PatternAngle);
                #endif
                return o;
            }
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                #ifdef TILE_ON
                inputColor *= tex2D(_PatternTex, i.uvRotated);
                #endif
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                #ifdef TILE_ON
                brushColor *= tex2D(_PatternTex, i.uvRotated);
                #endif
